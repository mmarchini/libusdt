...
typedef struct dtrace_difo {
	...
	unsigned int dtdo_len;		/* length of instruction buffer */
	unsigned int dtdo_intlen;		/* length of integer table */
	unsigned int dtdo_strlen;		/* length of string table */
	unsigned int dtdo_varlen;		/* length of variable table */
	dtrace_diftype_t dtdo_rtype;	/* return type */
	unsigned int dtdo_refcnt;		/* owner reference count */
	unsigned int dtdo_destructive;	/* invokes destructive subroutines */
#ifndef _KERNEL
	...
	unsigned int dtdo_krelen;		/* length of krelo table */
	unsigned int dtdo_urelen;		/* length of urelo table */
	unsigned int dtdo_xlmlen;		/* length of translator table */
#endif
} dtrace_difo_t;
...
typedef struct dtrace_conf {
	unsigned int dtc_difversion;			/* supported DIF version */
	unsigned int dtc_difintregs;			/* # of DIF integer registers */
	unsigned int dtc_diftupregs;			/* # of DIF tuple registers */
	unsigned int dtc_ctfmodel;			/* CTF data model */
	unsigned int dtc_pad[8];			/* reserved for future use */
} dtrace_conf_t;
